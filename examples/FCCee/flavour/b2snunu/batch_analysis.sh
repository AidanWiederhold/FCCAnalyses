...
# pickle stage1
python ./examples/FCCee/flavour/b2snunu/scripts/pickler.py --input ${ANALYSISOUTPUT}stage1/p8_ee_Zbb_ecm91_EvtGen_Bd2KstNuNu/* --vars train_vars_vtx &> ${ANALYSISOUTPUT}logs/pickle_signal.log
