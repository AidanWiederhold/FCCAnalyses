...
def main():
    ...
    parser.add_argument("--bb_pkl", nargs="+", required=True, help="bkg Z -> bb ntuples")
    parser.add_argument("--cc_pkl", nargs="+", required=True, help="bkg Z -> cc ntuples")
    parser.add_argument("--ss_pkl", nargs="+", required=True, help="bkg Z -> ss ntuples")
    parser.add_argument("--ud_pkl", nargs="+", required=True, help="bkg Z -> light qq ntuples")
    parser.add_argument("--signal_root", nargs="+", required=True, help="signal ntuples")
    parser.add_argument("--bb_roor", nargs="+", required=True, help="bkg Z -> bb ntuples")
    parser.add_argument("--cc_root", nargs="+", required=True, help="bkg Z -> cc ntuples")
    parser.add_argument("--ss_root", nargs="+", required=True, help="bkg Z -> ss ntuples")
    parser.add_argument("--ud_root", nargs="+", required=True, help="bkg Z -> light qq ntuples")
